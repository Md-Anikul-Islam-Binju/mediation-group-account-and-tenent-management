...
<head>
    <meta charset="utf-8" />
    <title>Dashboard | CoderNetix Tenant Management</title>
                ...
                <li class="side-nav-item">
                    ...
                    <div class="collapse" id="sidebarPages">
                        <ul class="side-nav-second-level">
                            ...
                            @can('owner-list')
                            <li>
                                <a href="{{route('owner.section')}}">Owner List</a>
                            </li>
                            @endcan

                            @can('owner-bank-list')
                                <li>
                                    <a href="{{route('owner.bank.section')}}">Owner Bank</a>
                                </li>
                            @endcan

                            @can('owner-flat-list')
                                <li>
                                    <a href="{{route('owner.flat.section')}}">Owner Flat</a>
                                </li>
                            @endcan
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12 text-center">
                        <script>document.write(new Date().getFullYear())</script> © Mediation Group Account Management</b>
                    </div>
                </div>
            </div>
        </footer>
